...
export const ClockAmountIcon: React.VFC<ClockAmountIconProps> = ({ rate }) => {
    ...
    return (
        <svg viewBox={'0 0 24 24'}>
            <g stroke={'black'} strokeWidth={2} strokeLinecap={'round'}>
                <circle cx={12} cy={12} r={11} fill={colorBg} stroke={'black'} strokeWidth={2} />
            </g>
            <path d={`M12 12L12 2A10 10 0 0 1 ${12 + x1} ${12 + y1}z`} fill={colorRate} />
            <path d={`M12 12L12 22A10 10 0 0 1 ${12 + x2} ${12 + y2}z`} fill={colorRate} />
        </svg>
    );
};
