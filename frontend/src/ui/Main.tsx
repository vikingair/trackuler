    ...
    (description: string) => {
      ...
      return TrackService.current()
        ...
        .then(() => {
          ...
          setRecording(false);
          if (
            CategoryService.isEnd(
              CategoryService.getWithColor(
                Store.get().categoryConfig,
                description,
              ),
            )
          )
        ...
        <>
          ...
          {started ? (
            ...
            <div className="microphone microphone--start">
              <p>
                {tracks.length ? "Continue" : "Start a new"} session by clicking
                on the Microphone.
              </p>
              <button
                className={"icon-button"}
